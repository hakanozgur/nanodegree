class SqlQueries:
    """
    insert statements from sparkify dataset
    """
    songplay_table_insert = ("""
         INSERT INTO songplays (
            ...
            ) songplay_id, events.start_time,  events.userid,  events.level,  songs.song_id,  songs.artist_id,  events.sessionid,  events.location,  events.useragent 
        FROM
            (SELECT
        ...
        JOIN
            staging_songs songs ON events.song = songs.title 
