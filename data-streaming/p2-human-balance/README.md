...
```
docker exec -it  data_streaming_p2_redis_1 redis-cli
```
...
```
docker exec -it  data_streaming_p2_kafka_1 kafka-console-consumer --bootstrap-server localhost:9092 --topic redis-server
```
...
```
docker logs -f data_streaming_p2_spark_1 | Out-File ./spark/logs/spark-master.log

docker logs -f data_streaming_p2_spark_1 | Out-File ./spark/logs/spark-master.log


docker logs  data_streaming_p2_spark_1 >& ./spark/logs/spark-master.log >& ./spark/logs/spark-worker.log


docker logs  data_streaming_p2_spark_1 >& spark/logs/spark-master.log
