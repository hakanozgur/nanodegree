...
#%%
# spark application
spark = SparkSession.builder.appName("p2_hkn_redis_server").getOrCreate()
...
# run 
# /scripts/submit-redis-kafka-streaming.cmd

# oputput is in /spark/logs/redis-kafka.log in the format 
